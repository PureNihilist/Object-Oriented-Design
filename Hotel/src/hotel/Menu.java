                        ...
                        while(true){
                            ...
                            switch(choice) {
                                ...
                                case 2://wyswietla rezerwacje dla zalogowanego klienta
                                    ...
                                    break;
                                case 3://wyswietla wolne pokoje ale... aktualnie :)
                                    System.out.println("Wyświetlanie akualnie wolnych pokoi");
                                    LocalDate today = LocalDate.now();
                                    PeriodControl todaysFreeRooms = new PeriodControl(today,today);
